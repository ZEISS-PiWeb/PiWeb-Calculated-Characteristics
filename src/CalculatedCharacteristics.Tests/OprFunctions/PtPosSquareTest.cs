...
namespace Zeiss.PiWeb.Shared.CalculatedCharacteristics.Tests.OprFunctions
{
	...
	public class PtPosSquareTest
	{
		...
		[TestCase( "PT_POS_SQUARE({../Mp1};\"YX\")" )]
		[TestCase( "PT_POS_SQUARE({../Mp1};\"ZX\")" )]
		[TestCase( "PT_POS_SQUARE({../Mp1};\"ZY\")" )]
		...
		[TestCase( "PT_POS_SQUARE({../Mp1};\"YXZ\")" )]
		[TestCase( "PT_POS_SQUARE({../Mp1};\"ZXY\")" )]
		[TestCase( "PT_POS_SQUARE({../Mp1};\"ZYX\")" )]
